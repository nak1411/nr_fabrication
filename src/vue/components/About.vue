<template>
  <div id="about">
    <div class="site__content">
      <h2 class="site__title">About NR Fabrication</h2>
      <section class="site__services site__grid--double">
        <div class="site__about--container">
        ...
        <img class="site__aboutimg" src="/src/img/nate_01-min.jpg" alt="about nr fabrication placeholder image">
      </section>
    </div>
  </div>
</template>
